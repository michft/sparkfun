...
// combined open and chdir.  Note that current directory is readable via readbyte and current buf - readnext
...
// file read systm so the structures won't be valid before a seek.  When
